...
namespace Pegasus.Services
{
    public class KladosUnifiedService : IKladosUnifiedService, IDisposable
    {
        ...
        public KladosUnifiedService(PegasusDBEntities entities)
        {
        ...
        {
            SYS_KLADOS_ENIAIOS entity = entities.SYS_KLADOS_ENIAIOS.Find(data.ΚΛΑΔΟΣ_ΚΩΔ);
        ...
        public KladosUnifiedViewModel Refresh(int entityId)
        {
            return entities.SYS_KLADOS_ENIAIOS.Select(d => new KladosUnifiedViewModel
            {
                ...
                ΚΛΑΔΟΣ_ΕΝΙΑΙΟΣ = d.ΚΛΑΔΟΣ_ΕΝΙΑΙΟΣ,
                ΚΛΑΔΟΣ = d.ΚΛΑΔΟΣ
            }).Where(d => d.ΚΛΑΔΟΣ_ΚΩΔ.Equals(entityId)).FirstOrDefault();
        }


        public List<sqlEidikotitesKUViewModel> GetEidikotites(int kladosunifiedId)
        {
        ...
        public void ResetEidikotita(sqlEidikotitesKUViewModel data)
        {
            SYS_EIDIKOTITES entity = entities.SYS_EIDIKOTITES.Find(data.EIDIKOTITA_ID);
